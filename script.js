                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center space-x-2 mb-1">
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            ${isLink ? `
                                                <a href="${escapeHtml(actualValue)}" target="_blank" rel="nofollow noopener noreferrer" class="cursor-pointer text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors" title="Open link">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
